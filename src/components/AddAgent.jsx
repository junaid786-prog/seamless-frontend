...
const AddAgent = ({ changeSubSidebarIndex }) => {
    // agent information
    ...
    const AgentData = {
        ...
        referer, remark, products: selectedProducts
    }
    ...
    }, [ready, loading, isCreated, error, alert])
                                ...
                                <div className='products_list products_list_a'>
                                    <div>
                                        {productsList && productsList.filter(product => product.Category === category).map((product, key) => {
                                            return <AddProduct add={add} selectedProducts={selectedProducts} product={product} />
                                        })}
                                    </div>
                                </div>
                            </div >
